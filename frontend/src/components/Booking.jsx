      ...
      <div className="w-full ">
        <div className="wrapper">
          <div className="hero-slides h-[80vh] relative">
            ...
            >
              <SwiperSlide>
                <img className="w-full" src="/images/booking/family-deluxe01_compressed.jpg" alt="family-deluxe01_compressed.jpg" />
              </SwiperSlide>
              <SwiperSlide>
                <img className="w-full" src="/images/booking/family-studio01_compressed.jpg" alt="family-studio01_compressed.jpg" />
              </SwiperSlide>
              <SwiperSlide>
                <img className="w-full" src="/images/booking/family-suite01_compressed.jpg" alt="family-suite01_compressed.jpg" />
              </SwiperSlide>
              <SwiperSlide>
                <img className="w-full" src="/images/booking/resort-room-front_compressed.jpg" alt="resort-room-front_compressed.jpg" />
              </SwiperSlide>
              <SwiperSlide>
                <img className="w-full" src="/images/booking/family-suite02_compressed.jpg" alt="family-suite02_compressed.jpg" />
              </SwiperSlide>
              <SwiperSlide>
                <img className="w-full" src="/images/booking/family-studio02_compressed.jpg" alt="family-studio02_compressed.jpg" />
              </SwiperSlide>
            </Swiper>
            ...
            <div className="family-suite flex flex-col gap-5 justify-center">
              ...
              <LazyDiv>
                ...
                <div id="booking-room1" className="bg-white w-full rounded-xl shadow-lg overflow-hidden mb-12 transition-all duration-300 hover:shadow-xl border border-stone-100">
                    ...
                    <div className="p-7 lg:w-2/5">
                      ...
                      <div className="space-y-4 mt-6">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <p className="">2 lantai, kapasitas 4 dewasa + 2 anak. 1 king bed dan 1 single large</p>
                          </div>
                        </div>
                  ...
                  {/* Kebijakan Kapasitas Kamar */}
                  <div className="p-4 m-3 bg-amber-50 rounded-lg border border-amber-200">
                    <details className="group">
                      <summary className="cursor-pointer font-semibold text-amber-800 flex items-center">
                        <FontAwesomeIcon icon="fa-solid fa-info-circle" className="mr-2 text-amber-700" />
                        Kebijakan Kapasitas Kamar
                        <span className="ml-auto text-xs text-amber-600 group-open:hidden">(Klik untuk lihat)</span>
                        <span className="ml-auto text-xs text-amber-600 hidden group-open:inline">(Tutup)</span>
                      </summary>

                      <ul className="text-sm text-amber-700 space-y-1 mt-2 pl-5 list-disc">
                        <li>Kapasitas standar: 4 dewasa + 2 anak (usia di bawah 12 tahun)</li>
                        <li>Extra bed: Rp 150.000/malam (termasuk sarapan)</li>
                        <li>Maksimal 8 orang per kamar</li>
                        <li>Wajib extra bed jika lebih dari 4 dewasa</li>
                        <li>Wajib extra bed jika 4 dewasa + 3–4 anak</li>
                      </ul>
                    </details>
                  </div>
                </div>
                ...
                <div id="booking-room3" className="bg-white w-full rounded-xl shadow-lg overflow-hidden mb-12 transition-all duration-300 hover:shadow-xl border border-stone-100">
                    ...
                    <div className="p-7 lg:w-2/5">
                      ...
                      <div className="space-y-4 mt-6">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <p className="">1 lantai, Kapasitas 5 dewasa + 2 anak. 1 king bed dan 2 single large</p>
                          </div>
                        </div>
                  ...
                  <div className="p-4 m-3 bg-amber-50 rounded-lg border border-amber-200">
                    <details className="group">
                      ...
                      <ul className="text-sm text-amber-700 space-y-1 mt-2 pl-5 list-disc">
                        <li>Kapasitas standar: 5 dewasa + 2 anak (usia di bawah 12 tahun)</li>
                        <li>Extra bed: Rp 150.000/malam (termasuk sarapan)</li>
                        <li>Maksimal 8 orang per kamar</li>
                        <li>Wajib extra bed jika lebih dari 5 orang dewasa</li>
                        <li>Wajib extra bed jika 4 dewasa + 3–4 anak</li>
                      </ul>
                    </details>
                  </div>
